...
class Caseolap(object):
    ...
    def __init__(self,cell2pmids,pmid2pcount,result_dir,logfile):
        
        self.cellnames = []
        self.cell2pmids = cell2pmids
    ...
    def cell_pmids_collector(self, dump = False,verbose =False):
            if verbose:
                print('Total pmids collected for cell:')
            for key,value in self.cell2pmids.items():
                cell_name = key
                cell_pmids = value
                ...
                if verbose:
                    print(cell_name,len(cell_pmids))
    ...
    def all_protein_finder(self,dump =False,verbose = False):
            allproteins = []
            if verbose: 
                print('\nTotal entities collected for cell:')
