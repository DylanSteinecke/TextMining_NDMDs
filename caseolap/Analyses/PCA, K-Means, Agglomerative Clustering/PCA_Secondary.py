...
pca_results(wt_data, pca, fname = 'Analyses/PCA, K-Means, Agglomerative Clustering/Data/pca-mito-secondary-weights.pdf')
pca_results(wt_data, pca, fname = 'Analyses/PCA, K-Means, Agglomerative Clustering/Data/pca-mito-secondary-weights.png')
...
# Create a biplot
biplot(newdata, reduced_data, pca,'Analyses/PCA, K-Means, Agglomerative Clustering/Data/protein-secondary-biplot.pdf',clrs);
biplot(newdata, reduced_data, pca,'Analyses/PCA, K-Means, Agglomerative Clustering/Data/protein-secondary-biplot.png',clrs);

newdata = ndf.copy(deep =True)
# Create a biplot
biplot_labeled_points(newdata, reduced_data, pca,'Analyses/PCA, K-Means, Agglomerative Clustering/Data/protein-secondary-labeled-biplot.pdf',clrs);
biplot_labeled_points(newdata, reduced_data, pca,'Analyses/PCA, K-Means, Agglomerative Clustering/Data/protein-secondary-labeled-biplot.png',clrs);

print('Made PCA of \'Secondary\' Mitochondrial Diseases...')
print('Finished!')